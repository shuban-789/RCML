...
This library has implementations for subjects ranging from multiivariable calculus to whatever miiscellaneous implementation I find interesting. The purpose of this project is so that my programming skills catch up with my math skills and I can translate whatever I learn in math into programming. This project will probably have functions based on the current math I take. 
